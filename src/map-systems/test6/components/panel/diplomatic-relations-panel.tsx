  ...
  return (
    <div className="bg-slate-950/60 p-4 rounded-2xl border border-slate-850 space-y-2">
      <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider font-mono">
        Diplomatic Bureau: {targetCountryName}
      </h3>
      <div className="grid grid-cols-2 gap-2">
        <button
          onClick={() => onPropose("NON_AGGRESSION_PACT")}
          className="py-2 bg-slate-900 border border-slate-800 hover:bg-slate-800 text-[10px] text-slate-300 font-bold rounded-lg transition-all font-mono"
        >
          Propose Pact
        </button>
        <button
        ...
        <button
          ...
          className="py-2 bg-rose-950/20 border border-rose-900/40 hover:bg-rose-900/30 text-[10px] text-rose-400 font-bold rounded-lg transition-all font-mono"
        >
          Declare War
        </button>
      </div>
