  ...
  return (
    <div className="space-y-2.5">
      ...
      <div className="space-y-2 font-mono text-xs">
        ...
        <div className="bg-background/40 border border-border/60 p-3 rounded-xl space-y-1.5">
          <div className="flex justify-between text-[10px]">
            <span className="text-muted-foreground">شاخص فساد اداری</span>
            <span className="font-bold text-military">{corruption}%</span>
          </div>
          <div className="w-full bg-secondary h-1.5 rounded-full overflow-hidden">
            <div
              className="bg-military h-full rounded-full transition-all"
