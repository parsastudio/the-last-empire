...
export function AmbientTacticalGrid() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div className="absolute top-20 start-6 sm:top-24 sm:start-8 font-mono text-[9px] text-muted-foreground/40 tracking-widest flex items-center gap-2 select-none">
        <span className="w-1.5 h-1.5 rounded-full bg-primary/60 animate-ping" />
        <span>SYS_REF: 44.2026.FA | EMPIRE_CORE</span>
      </div>
      <div className="absolute top-20 end-6 sm:top-24 sm:end-8 font-mono text-[9px] text-muted-foreground/40 tracking-widest hidden sm:block select-none">
