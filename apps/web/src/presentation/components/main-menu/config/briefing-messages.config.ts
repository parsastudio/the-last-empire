...
export const INITIAL_BRIEFING_MESSAGES: FeedMessage[] = [
  ...
  },
  {
    id: "3",
    type: "warning",
    text: "گزارش زیرساخت: میزان تراکم مسکن در پایتخت به حد هشدار ۹۸٪ رسیده است.",
    time: "۵ دقیقه پیش",
  },
  {
    id: "4",
  ...
  },
  {
    id: "14",
    type: "info",
    text: "بازار کار: نرخ بهره‌وری سرانه نیروی کار در این نوبت رشد مثبت ثبت کرد.",
    time: "۱ ساعت پیش",
  },
  {
    id: "15",
  ...
  },
  {
    id: "18",
    type: "info",
    text: "طرح جدید ارتقای فناوری در ستاد فرماندهی آماده بهره‌برداری است.",
    time: "۲ ساعت پیش",
  },
  {
    id: "19",
